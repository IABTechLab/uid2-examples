...
- Via the standard integration workflow, using the [Client-Side JavaScript SDK](https://unifiedid.com/docs/sdks/client-side-identity) (also known as the UID2 SDK).
