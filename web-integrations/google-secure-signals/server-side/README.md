...
For an example application using the [UID2 SDK for JavaScript](https://unifiedid.com/docs/sdks/sdk-ref-javascript), see [Client-Server UID2 SDK Integration Example with Google Secure Signals](https://github.com/IABTechLab/uid2-examples/tree/main/web-integrations/google-secure-signals/client-server) or [Client-Side UID2 SDK Integration Example with Google Secure Signals](https://github.com/IABTechLab/uid2-examples/tree/main/web-integrations/google-secure-signals/client-side).
